  ...
  if (done) {
    return (
      <div className="flex flex-col items-center gap-4 py-8 text-center">
        ...
        <p className="font-semibold text-slate-800">Declaration saved successfully</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Field label="Product ID *">
          <input
            ...
            placeholder="UUID from product catalog"
            className={inputCls}
          />
        </Field>
        ...
        <Field label="Supplier Country *">
          <CountrySelect
            ...
            onChange={(v) => set("supplier_country", v)}
          />
        </Field>
...
const inputCls =
  "w-full rounded-lg border border-[#E2E8F0] bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#2563EB] focus:outline-none focus:ring-1 focus:ring-[#2563EB]";

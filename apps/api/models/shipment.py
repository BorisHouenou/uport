...
class Shipment(Base, TimestampMixin):
    ...
    organization: Mapped["Organization"] = relationship(
        "Organization", back_populates="shipments"
    )
    determinations: Mapped[list["OriginDetermination"]] = relationship(
        "OriginDetermination", back_populates="shipment"
    )
    certificates: Mapped[list["Certificate"]] = relationship(
        "Certificate", back_populates="shipment"
    )

...
def generate_certificate_task(
    self, org_id: str, shipment_id: str, cert_type: str, determination_id: str
):
    ...
    try:
        ...
        result = generate_and_store_certificate_sync(
            org_id, shipment_id, cert_type, determination_id
        )
        return {
            "status": "completed",
